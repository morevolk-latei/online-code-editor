	...
	<section class="main-section">
		...
		<div class="main-container">
			...
			<div class="questions-list-box">
				<div class="wrapper">
					<div class="questions-buttons" ng-repeat="(key, value) in quesList">
						<input type="button" name="{{value}}" value="{{value}}" ng-click="showQuestion(key,value,$event)" ng-class="{active: key === 0}">
						<!-- <li ng-click="showQuestion(key,value)">{{value}}</li> -->
					</div>
				</div>
			</div>
							...
							<div class="question-container" ng-class="{'active': isQuestionBox}">
								<section class="question-box">
									<p class="question question-box-common-rules">
										<font style="color: #556; font-weight: bold; ">{{problemStatement.id}}</font><br/><br/>
									...
									<div class="test-cases question-box-common-rules">
										...
										<aside>
											<div>
												<pre>
													<li ng-repeat="testCase in problemStatement.testCases"><span ng-bind-html="testCase"></span></li>
												</pre>
									...
									<div class="sample-output-box question-box-common-rules">
										<aside class="left">
											<h4>Sample input: </h4>
												<div>
													<li ng-repeat="sampleInput in problemStatement.sampleInput">{{sampleInput}}</li>
												</div>
<!-- <pre>
2
4
...
10 40 56 1 4 91 0
										...
										<aside class="right">
											<h4>Sample output: </h4>
												<div>
													<li ng-repeat="sampleOutput in problemStatement.sampleOutput">{{sampleOutput}}</li>
												</div>
<!-- <pre>									
10
45
